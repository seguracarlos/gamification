...
class GamificationController extends AbstractActionController
{
    public function indexAction()
    {
        ...
        $achievmentsByCategory = $playService->getAchievmentsByCategory();
        //echo "<pre>"; print_r($achievmentsByCategory); exit;
        ...
        $view = array('user' => $userInfo, 'achievments' => $achievementsByCategory,'taskMadeByUser' => $taskMadeByUser,'achievementsByUser' => $achievementsByUser,'categoryByUser' => $categoryByUser, 'levelsByUser' => $levelsByUser, 'achievmentsByCategory' => $achievmentsByCategory );
